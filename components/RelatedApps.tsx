  ...
  return (
    <>
      ...
      <div>
        ...
        {currentAppSlug === 'top-war-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Strategy & merge builder mods</a></li>
        ...
        {currentAppSlug === 'war-and-order-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Strategy & war builder mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/top-war-mod">Top War – Unlimited Diamonds & Coins</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/forge-of-empires-mod">Forge of Empires – Unlimited Diamonds & Supplies</a></li>
            </ul>
          </div>
        ...
        {currentAppSlug === 'need-for-speed-no-limits-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Racing & street mods</a></li>
        ...
        {currentAppSlug === 'traffic-rider-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Racing & motorcycle mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/need-for-speed-no-limits-mod">NFS No Limits – Unlimited Money & Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/carx-street-mod">CarX Street – Unlimited Money</a></li>
            </ul>
          </div>
        ...
        {currentAppSlug === 'fr-legends-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Racing & drift game mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/carx-street-mod">CarX Street – Unlimited Money</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/need-for-speed-no-limits-mod">NFS No Limits – Unlimited Money & Gold</a></li>
            </ul>
          </div>
        ...
        {currentAppSlug === 'world-chef-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Builder & life simulation mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/the-sims-mod">The Sims™ – Unlimited Money & SimCash</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/top-war-mod">Top War – Unlimited Diamonds & Coins</a></li>
            </ul>
          </div>
        )}
        ...
        {currentAppSlug === 'infinity-kingdom-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Strategy & kingdom builder mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/forge-of-empires-mod">Forge of Empires – Unlimited Diamonds & Supplies</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/top-war-mod">Top War – Unlimited Diamonds & Coins</a></li>
            </ul>
          </div>
        ...
        {currentAppSlug === 'pocket-troops-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Tactical & squad battler mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/mighty-party-mod">Mighty Party – Unlimited Gems & Coins</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/infinity-kingdom-mod">Infinity Kingdom – Unlimited Gems</a></li>
            </ul>
          </div>
        )}
        ...
        {currentAppSlug === 'pvz-heroes-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Card battlers & strategy mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/disney-heroes-mod">Disney Heroes – Unlimited Diamonds & Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/king-of-thieves-mod">King of Thieves – Unlimited Orbs & Gold</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'basketball-stars-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Sports & basketball mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/efootball-2024-mod">eFootball 2024 – Unlimited Coins & GP</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/baseball-9-mod">Baseball 9 – Unlimited Money & Gems</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'nba-live-mobile-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Sports & basketball mods</a></li>
        ...
        {currentAppSlug === 'score-hero-2022-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Football & sports mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/efootball-2024-mod">eFootball 2024 – Unlimited Coins & GP</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/fc-mobile-24-25-mod">FC Mobile 24/25 – Unlimited Points & Gems</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'skullgirls-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Fighting & action RPG mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/mortal-kombat-mod">Mortal Kombat – Unlimited Souls & Coins</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/injustice-2-mod">Injustice 2 – Unlimited Gems & Credits</a></li>
            </ul>
          </div>
        ...
        {currentAppSlug === 'project-makeover-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Match‑3 & makeover mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/harry-potter-puzzles-and-spells-mod">HP: Puzzles & Spells – Unlimited Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/match-masters-mod">Match Masters – Unlimited Coins</a></li>
            </ul>
          </div>
        ...
        {currentAppSlug === 'looney-tunes-world-of-mayhem-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Cartoon & casual battle mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/harry-potter-puzzles-and-spells-mod">HP: Puzzles & Spells – Unlimited Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/monopoly-go-plus-plus">Monopoly Go++ – Unlimited Dice & Cash</a></li>
            </ul>
          </div>
        ...
        {currentAppSlug === 'king-of-thieves-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Strategy & dungeon mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/monster-legends-mod">Monster Legends – Unlimited Gems & Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/top-war-mod">Top War – Unlimited Diamonds & Coins</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'dungeon-hunter-5-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Action RPG & dungeon mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/king-of-thieves-mod">King of Thieves – Unlimited Orbs & Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/monster-legends-mod">Monster Legends – Unlimited Gems & Gold</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'monster-legends-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Monsters & strategy mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/king-of-thieves-mod">King of Thieves – Unlimited Orbs & Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/dc-legends-mod">DC Legends – Unlimited Gems & Energy</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'dragon-mania-legends-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Monsters & breeding strategy mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/monster-legends-mod">Monster Legends – Unlimited Gems & Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/king-of-thieves-mod">King of Thieves – Unlimited Orbs & Gold</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'scrabble-go-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Word & puzzle mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/harry-potter-puzzles-and-spells-mod">HP: Puzzles & Spells – Unlimited Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/match-masters-mod">Match Masters – Unlimited Coins</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'disney-heroes-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">RPG & squad battler mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/dislyte-mod">Dislyte – Unlimited Crystals & Gold</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/lol-wild-rift-mod">LOL: Wild Rift – Unlimited Wild Cores</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'state-of-survival-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Strategy & survival mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/war-and-order-mod">War and Order – Unlimited Gems & Coins</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/top-war-mod">Top War – Unlimited Diamonds & Coins</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'hungry-shark-evolution-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Arcade & action mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/jetpack-joyride-mod">Jetpack Joyride – Unlimited Coins</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/angry-birds-evolution-mod">Angry Birds Evolution – Unlimited Gems</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'soul-knight-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Roguelike & action mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/frag-pro-shooter-mod">FRAG Pro Shooter – Unlimited Diamonds & Coins</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/roblox-mod">Roblox – Mod Menu</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'criminal-case-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Investigation & puzzle mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/scrabble-go-mod">Scrabble GO – Unlimited Gems</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/harry-potter-puzzles-and-spells-mod">HP: Puzzles & Spells – Unlimited Gold</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'frag-pro-shooter-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Shooter & action mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/cod-mobile-mod-menu">COD Mobile – MOD Menu</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/guns-of-boom-mod">Guns of Boom – Unlimited Money & Gold</a></li>
            </ul>
          </div>
        )}
        {currentAppSlug === 'dc-legends-mod' && (
          <div className="mt-6 text-sm text-gray-400">
            <p className="mb-2">Helpful links:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><a className="text-[#00ff88] hover:underline" href="/category/games">Heroes & action mods</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/injustice-2-mod">Injustice 2 – Unlimited Gems & Credits</a></li>
              <li><a className="text-[#00ff88] hover:underline" href="/app/mortal-kombat-mod">Mortal Kombat – Unlimited Souls & Coins</a></li>
            </ul>
          </div>
