    ...
    <header className="py-8">
      <div className="px-4">
        <div className="flex flex-col items-center justify-center space-y-1 text-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-14 h-14 text-white" viewBox="0 0 24 24" fill="currentColor">
          ...
          <h1 className="text-4xl font-black tracking-wide text-white [text-shadow:0_0_15px_rgba(0,255,136,0.4),0_0_30px_rgba(0,255,136,0.2)]">AppsGU</h1>
          <h6 className="text-sm font-light text-gray-400">- #1 Free Mods Store for iOS & Android -</h6>
        </div>
      </div>
    </header>
  );
