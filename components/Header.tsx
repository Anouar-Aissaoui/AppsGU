  ...
  return (
    <header className="py-8 lg:py-4">
      <a href="/" className="block">
        <div className="px-4">
          <div className="flex flex-col items-center justify-center space-y-1 text-center lg:space-y-0">
            ...
            <h6 className="text-sm lg:text-xs font-light text-gray-400">- #1 Free Mods Store for iOS & Android -</h6>
          </div>
        </div>
      </a>
    </header>
