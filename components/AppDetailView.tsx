...
const SeoHead: React.FC<{ app: AppInfo }> = ({ app }) => {
    useEffect(() => {
        ...
        // HowTo Schema (Programmatic SEO) for Traffic Rider Mod
        if (app.slug === 'traffic-rider-mod') {
            addJsonLd({
                "@context": "https://schema.org",
                "@type": "HowTo",
                "name": "How to Activate Traffic Rider Mod (Unlimited Money & Cash)",
                "totalTime": "PT2M",
                "estimatedCost": { "@type": "MonetaryAmount", "currency": "USD", "value": "0" },
                "step": [
                    { "@type": "HowToStep", "name": "Install Mod", "text": "Download and install Traffic Rider Mod on your device." },
                    { "@type": "HowToStep", "name": "Open Game", "text": "Launch Traffic Rider; money and cash sync automatically." },
                    { "@type": "HowToStep", "name": "Upgrade & Ride", "text": "Buy bikes and upgrades; aim for near‑miss bonuses to score more." }
                ]
            });
        }
        ...
        // HowTo Schema (Programmatic SEO) for Pocket Troops Mod
        if (app.slug === 'pocket-troops-mod') {
            addJsonLd({
                "@context": "https://schema.org",
                "@type": "HowTo",
                "name": "How to Activate Pocket Troops Mod (Unlimited Coins & Cash)",
                "totalTime": "PT2M",
                "estimatedCost": { "@type": "MonetaryAmount", "currency": "USD", "value": "0" },
                "step": [
                    { "@type": "HowToStep", "name": "Install Mod", "text": "Download and install Pocket Troops Mod on your device." },
                    { "@type": "HowToStep", "name": "Open Game", "text": "Launch Pocket Troops; coins and cash sync automatically." },
                    { "@type": "HowToStep", "name": "Train Squad", "text": "Recruit and train units; upgrade weapons to clear missions." }
                ]
            });
        }
        ...
        // HowTo Schema (Programmatic SEO) for War and Order Mod
        if (app.slug === 'war-and-order-mod') {
            addJsonLd({
                "@context": "https://schema.org",
                "@type": "HowTo",
                "name": "How to Activate War and Order Mod (Unlimited Gems & Coins)",
                "totalTime": "PT2M",
                "estimatedCost": { "@type": "MonetaryAmount", "currency": "USD", "value": "0" },
                "step": [
                    { "@type": "HowToStep", "name": "Install Mod", "text": "Download and install War and Order Mod on your device." },
                    { "@type": "HowToStep", "name": "Open City", "text": "Launch the game; gems and coins sync automatically." },
                    { "@type": "HowToStep", "name": "Upgrade & Train", "text": "Speed buildings/research and train troops to expand power." }
                ]
            });
        }
        ...
        // HowTo Schema (Programmatic SEO) for Project Makeover Mod
        if (app.slug === 'project-makeover-mod') {
            addJsonLd({
                "@context": "https://schema.org",
                "@type": "HowTo",
                "name": "How to Activate Project Makeover Mod (Unlimited Gems & Coins)",
                "totalTime": "PT2M",
                "estimatedCost": { "@type": "MonetaryAmount", "currency": "USD", "value": "0" },
                "step": [
                    { "@type": "HowToStep", "name": "Install Mod", "text": "Download and install Project Makeover Mod on your device." },
                    { "@type": "HowToStep", "name": "Open Game", "text": "Launch Project Makeover; resources sync automatically." },
                    { "@type": "HowToStep", "name": "Style & Renovate", "text": "Use boosters and outfits to clear levels and complete makeovers." }
                ]
            });
        }
        ...
        // HowTo Schema (Programmatic SEO) for Disney Heroes Mod
        if (app.slug === 'disney-heroes-mod') {
            addJsonLd({
                "@context": "https://schema.org",
                "@type": "HowTo",
                "name": "How to Activate Disney Heroes Mod (Unlimited Diamonds & Gold)",
                "totalTime": "PT2M",
                "estimatedCost": { "@type": "MonetaryAmount", "currency": "USD", "value": "0" },
                "step": [
                    { "@type": "HowToStep", "name": "Install Mod", "text": "Download and install Disney Heroes Mod on your device." },
                    { "@type": "HowToStep", "name": "Open Game", "text": "Launch Disney Heroes; resources sync automatically." },
                    { "@type": "HowToStep", "name": "Build Squad", "text": "Summon heroes, equip disks and clear trials/events." }
                ]
            });
        }
        ...
        // HowTo Schema (Programmatic SEO) for NBA Live Mobile Mod
        if (app.slug === 'nba-live-mobile-mod') {
            addJsonLd({
                "@context": "https://schema.org",
                "@type": "HowTo",
                "name": "How to Activate NBA Live Mobile Mod (Unlimited Cash & Coins)",
                "totalTime": "PT2M",
                "estimatedCost": { "@type": "MonetaryAmount", "currency": "USD", "value": "0" },
                "step": [
                    { "@type": "HowToStep", "name": "Install Mod", "text": "Download and install NBA Live Mobile Mod on your device." },
                    { "@type": "HowToStep", "name": "Open Game", "text": "Launch NBA Live Mobile; cash and coins sync automatically." },
                    { "@type": "HowToStep", "name": "Upgrade Lineup", "text": "Open packs, train players and boost team chemistry." }
                ]
            });
        }
